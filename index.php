        ...
        <div class="row">
          ...
          <div class="col-lg-5 pt-5">
            <div class="hero-banner__content">
              ...
              <p>Silakan Login Untuk Mengisi Absensi Kalian. | Sistem Absensi Karyawan Klinik Maimunah Berbasis WEB😊🥰🫡</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">Rahman Dzuhrgi  </p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <p class="card-feature__subtitle">08564701324</p>
              </div>
            </div>
            <div class="col-lg-4">
              <div class="card card-feature text-center text-lg-left mb-4 mb-lg-0">
                ...
                <h3 class="card-feature__title">Istagram</h3>
                <p class="card-feature__subtitle">rahman_dzuhrgi_</p>
              </div>
            </div>
          </div>
        </div>
...
Program projek &copy;<script>document.write(new Date().getFullYear());</script> SISTEM INFORMASI ABSENSI Klinik Maimunah <i class="fa fa-heart" aria-hidden="true"></i>Desing by <a href="https://wa.me/6285664701324" target="_blank">WhatsAap</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
				<div class="col-lg-4 col-md-12 text-center text-lg-right footer-social">
					<a href="https://wa.me/6285664701324" target="_blank"><i class="fab fa-whatsaap-f"></i></a>
					<a href="https://github.com/ZibranovSky" target="_blank"><i class="fab fa-github"></i></a>
					<a href="https://www.instagram.com/rahman_dzuhrgi_?igsh=MWljazJnMXV5cDVmYg==" target="_blank" ><i class="fab fa-instagram" target="_blank"></i></a>
